box::use(
  ...
  readxl[read_excel],
  shiny.fluent[Checkbox.shinyInput, DefaultButton.shinyInput, PrimaryButton.shinyInput, Stack],
  shiny.fluent[TextField.shinyInput, updateCheckbox.shinyInput, updateDefaultButton.shinyInput,
